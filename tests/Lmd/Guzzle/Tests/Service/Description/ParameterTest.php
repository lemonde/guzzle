...
/**
 * @covers \Lmd\Guzzle\Service\Description\Parameter
 */
class ParameterTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testAllowsNestedShape()
    {
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Service\Description\Parameter', $param->getProperty('foo'));
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Service\Description\Parameter', $param->getProperty('bar'));
    ...
    public function testAddsAdditionalProperties()
    {
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Service\Description\Parameter', $p->getAdditionalProperties());
    ...
    public function testAddsItems()
    {
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Service\Description\Parameter', $p->getItems());
        $out = $p->toArray();
