...
namespace Lmd\Guzzle\Tests\Service\Description;
...
/**
 * @covers \Lmd\Guzzle\Service\Description\ServiceDescription
 */
class ServiceDescriptionTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    /**
     * @covers \Lmd\Guzzle\Service\Description\ServiceDescription::factory
     * @covers \Lmd\Guzzle\Service\Description\ServiceDescriptionLoader::build
     */
    public function testFactoryDelegatesToConcreteFactories()
    {
        $jsonFile = __DIR__ . '/../../TestData/test_service.json';
        $this->assertInstanceOf('Lmd\Guzzle\Service\Description\ServiceDescription', ServiceDescription::factory($jsonFile));
    }
    ...
    public function testContainsModels()
    {
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Service\Description\Parameter', $d->getModel('Tag'));
