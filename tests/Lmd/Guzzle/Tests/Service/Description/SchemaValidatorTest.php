...
/**
 * @covers \Lmd\Guzzle\Service\Description\SchemaValidator
 */
class SchemaValidatorTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    /** @var SchemaValidator */
    protected $validator;
    ...
    public function testCorrectlyConvertsParametersToArrayWhenArraysArePresent()
    {
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Service\Description\Parameter', $param->getItems());
    }
    ...
    {
        $o = $this->getMockBuilder('Lmd\Guzzle\Common\ToArrayInterface')
