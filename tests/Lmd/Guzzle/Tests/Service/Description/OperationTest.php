...
/**
 * @covers \Lmd\Guzzle\Service\Description\Operation
 */
class OperationTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testOperationIsDataObject()
    {
        ...
        $this->assertEquals('Lmd\\Guzzle\\Service\\Command\\OperationCommand', $c->getClass());
    ...
    public function testAllowsConcreteCommands()
    {
        $c = new Operation(array(
            'name' => 'test',
            'class' => 'Lmd\\Guzzle\\Service\\Command\ClosureCommand',
            'parameters' => array(
        ...
        $this->assertEquals('Lmd\\Guzzle\\Service\\Command\ClosureCommand', $c->getClass());
    }
    ...
    public function testHasData()
    {
        ...
        $this->assertEquals(array(
            'parameters'    => array(),
            'class'         => 'Lmd\Guzzle\Service\Command\OperationCommand',
    ...
    protected function getOperation()
    {
        return new Operation(array(
            ...
            'errorResponses' => array(
                array('code' => 503, 'reason' => 'InsufficientCapacity', 'class' => 'Lmd\\Guzzle\\Exception\\RuntimeException')
            )
        ));
    }
}
