...
/**
 * @covers \Lmd\Guzzle\Service\Exception\CommandTransferException
 */
class CommandTransferExceptionTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testConvertsMultiExceptionIntoCommandTransfer()
    {
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Service\Exception\CommandTransferException', $ce);
    ...
    public function testCanRetrieveExceptionForCommand()
    {
        ...
        $c1 = $this->getMockBuilder('Lmd\Guzzle\Tests\Service\Mock\Command\MockCommand')
