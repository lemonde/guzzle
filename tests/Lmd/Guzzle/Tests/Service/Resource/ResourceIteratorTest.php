...
use Lmd\Guzzle\Service\Resource\ResourceIterator;
use Lmd\Guzzle\Tests\Service\Mock\Model\MockCommandIterator;

/**
 * @group server
 * @covers \Lmd\Guzzle\Service\Resource\ResourceIterator
 */
class ResourceIteratorTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    {
        $ri = $this->getMockForAbstractClass('Lmd\\Guzzle\\Service\\Resource\\ResourceIterator', array(
    ...
    public function testWorksWithCustomAppendIterator()
    {
        ...
        $ri = new MockCommandIterator($this->getServiceBuilder()->get('mock')->getCommand('iterable_command'));
        $a = new \Lmd\Guzzle\Iterator\AppendIterator();
        $a->append($ri);
