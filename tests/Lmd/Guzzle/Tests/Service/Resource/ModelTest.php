...
/**
 * @covers \Lmd\Guzzle\Service\Resource\Model
 */
class ModelTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testCanBeUsedWithoutStructure()
    {
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Common\Collection', $model->getPath('Bar'));
    }
