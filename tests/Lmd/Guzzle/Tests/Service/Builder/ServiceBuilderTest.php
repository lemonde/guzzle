...
use Lmd\Guzzle\Plugin\History\HistoryPlugin;
use Lmd\Guzzle\Service\Builder\ServiceBuilder;
use Lmd\Guzzle\Service\Client;

/**
 * @covers \Lmd\Guzzle\Service\Builder\ServiceBuilder
 */
class ServiceBuilderTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testDelegatesFactoryMethodToAbstractFactory()
    {
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Tests\Service\Mock\MockClient', $c);
    }

    /**
     * @expectedException \Lmd\Guzzle\Service\Exception\ServiceNotFoundException
    ...
    public function testStoresClientCopy()
    {
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Tests\Service\Mock\MockClient', $client);
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Tests\Service\Mock\MockClient', $client2);
    ...
    public function testUsedAsArray()
    {
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Service\Client', $b['michael.mock']);
    ...
    public function testCanRegisterServiceData()
    {
        ...
        $this->assertTrue(isset($b['a']));
        $this->assertInstanceOf('Lmd\Guzzle\Tests\Service\Mock\MockClient', $b['a']);
        $client = $b['a'];
        unset($b['a']);
        $this->assertFalse(isset($b['a']));
