...
/**
 * @covers \Lmd\Guzzle\Service\AbstractConfigLoader
 */
class AbstractConfigLoaderTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    /** @var \Lmd\Guzzle\Service\AbstractConfigLoader */
    protected $loader;
    ...
    {
        $this->loader = $this->getMockBuilder('Lmd\Guzzle\Service\AbstractConfigLoader')
