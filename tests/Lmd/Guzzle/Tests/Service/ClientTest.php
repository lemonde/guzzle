...
use Lmd\Guzzle\Service\Exception\CommandTransferException;
...
/**
 * @group server
 * @covers \Lmd\Guzzle\Service\Client
 */
class ClientTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    protected $service;
    ...
    public function testExecutesCommands()
    {
        ...
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Message\\Response', $cmd->getResponse());
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Message\\Response', $cmd->getResult());
    ...
    public function testThrowsExceptionWhenMissingCommand()
    {
        ...
        $mock = $this->getMock('Lmd\\Guzzle\\Service\\Command\\Factory\\FactoryInterface');
    ...
    public function testOwnsResourceIteratorFactory()
    {
        ...
        $this->assertInstanceOf('Lmd\\Guzzle\\Service\\Resource\\ResourceIteratorClassFactory', $rf);
        $this->assertSame($rf1, $rf);

        $rf = new ResourceIteratorClassFactory('Lmd\Guzzle\Tests\Service\Mock');
    ...
    {
        $client = new Mock\MockClient();
        $this->assertInstanceOf('Lmd\Guzzle\Inflection\MemoizingInflector', $client->getInflector());
    ...
    /**
     * @expectedException \Lmd\Guzzle\Http\Exception\BadResponseException
     */
