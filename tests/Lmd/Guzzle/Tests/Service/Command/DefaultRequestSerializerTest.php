...
use Lmd\Guzzle\Service\Command\DefaultRequestSerializer;
...
use Lmd\Guzzle\Service\Command\LocationVisitor\Request\HeaderVisitor;
use Lmd\Guzzle\Service\Command\LocationVisitor\VisitorFlyweight;

/**
 * @covers \Lmd\Guzzle\Service\Command\DefaultRequestSerializer
 */
class DefaultRequestSerializerTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    /** @var EntityEnclosingRequest */
    protected $request;

    /** @var \Lmd\Guzzle\Service\Command\AbstractCommand */
    protected $command;
    ...
    public function setUp()
    {
        ...
        $this->command = $this->getMockBuilder('Lmd\Guzzle\Service\Command\AbstractCommand')
