...
use Lmd\Guzzle\Service\Command\LocationVisitor\Request\XmlVisitor;
...
/**
 * @covers \Lmd\Guzzle\Service\Command\LocationVisitor\Request\XmlVisitor
 */
class XmlVisitorTest extends AbstractVisitorTestCase
{
    ...
    public function testSerializesXml(array $operation, array $input, $xml)
    {
        ...
        $command = $this->getMockBuilder('Lmd\Guzzle\Service\Command\OperationCommand')
