...
use Lmd\Guzzle\Service\Resource\Model;
use Lmd\Guzzle\Service\Command\LocationVisitor\VisitorFlyweight;

/**
 * @covers \Lmd\Guzzle\Service\Command\OperationCommand
 */
class OperationCommandTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testPreparesRequestUsingSerializer()
    {
        ...
        $s = $this->getMockBuilder('Lmd\Guzzle\Service\Command\RequestSerializerInterface')
    ...
    {
        $op = new OperationCommand(array(), new Operation());
        $p = $this->getMockBuilder('Lmd\Guzzle\Service\Command\ResponseParserInterface')
