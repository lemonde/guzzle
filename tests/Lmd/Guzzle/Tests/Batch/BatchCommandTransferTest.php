...
use Lmd\Guzzle\Batch\BatchCommandTransfer;
use Lmd\Guzzle\Service\Client;
use Lmd\Guzzle\Tests\Service\Mock\Command\MockCommand as Mc;

/**
 * @covers \Lmd\Guzzle\Batch\BatchCommandTransfer
 */
class BatchCommandTransferTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    {
        $client = $this->getMockBuilder('Lmd\Guzzle\Service\Client')
    ...
    /**
     * @expectedException \Lmd\Guzzle\Service\Exception\InconsistentClientTransferException
     */
