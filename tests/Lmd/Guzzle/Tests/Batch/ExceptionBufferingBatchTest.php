...
use Lmd\Guzzle\Batch\ExceptionBufferingBatch;
use Lmd\Guzzle\Batch\Batch;
use Lmd\Guzzle\Batch\BatchSizeDivisor;

/**
 * @covers \Lmd\Guzzle\Batch\ExceptionBufferingBatch
 */
class ExceptionBufferingBatchTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    public function testFlushesEntireBatchWhileBufferingErroredBatches()
    {
        $t = $this->getMockBuilder('Lmd\Guzzle\Batch\BatchTransferInterface')
