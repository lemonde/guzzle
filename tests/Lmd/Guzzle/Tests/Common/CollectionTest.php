...
/**
 * @covers \Lmd\Guzzle\Common\Collection
 */
class CollectionTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    /** @var Collection */
    protected $coll;
    ...
    public function testUsesStaticWhenCreatingNew()
    {
        ...
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\QueryString', $qs->map(function($a, $b) {}));
        $this->assertInstanceOf('Lmd\\Guzzle\\Common\\Collection', $qs->map(function($a, $b) {}, array(), false));

        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\QueryString', $qs->filter(function($a, $b) {}));
        $this->assertInstanceOf('Lmd\\Guzzle\\Common\\Collection', $qs->filter(function($a, $b) {}, false));
    }
    ...
    public function testPreparesFromConfig()
    {
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Common\Collection', $c);
        $this->assertEquals(array(
            'a' => '123',
            'b' => 'lol',
            'base_url' => 'http://www.test.com/'
