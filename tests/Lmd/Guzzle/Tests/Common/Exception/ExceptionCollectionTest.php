...
use Lmd\Guzzle\Common\Exception\ExceptionCollection;

class ExceptionCollectionTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testAggregatesExceptions()
    {
        ...
        $e->add($exceptions[0]);
        $e->add($exceptions[1]);
        $this->assertContains("(Exception) ./tests/Lmd/Guzzle/Tests/Common/Exception/ExceptionCollectionTest.php line ", $e->getMessage());
    ...
    public function testCanAddSelf()
    {
        ...
        $this->assertContains("(Exception) ./tests/Lmd/Guzzle/Tests/Common/Exception/ExceptionCollectionTest.php line ", $message);
        $this->assertContains("\n    Test\n\n    #0 ", $message);
        $this->assertContains("\n\n(Lmd\\Guzzle\\Common\\Exception\\ExceptionCollection) ./tests/Lmd/Guzzle/Tests/Common/Exception/ExceptionCollectionTest.php line ", $message);
        $this->assertContains("\n\n    Meta description!\n\n", $message);
        $this->assertContains("    (Exception) ./tests/Lmd/Guzzle/Tests/Common/Exception/ExceptionCollectionTest.php line ", $message);
        $this->assertContains("\n        Test 2\n\n        #0 ", $message);
        $this->assertContains("        (Exception) ./tests/Lmd/Guzzle/Tests/Common/Exception/ExceptionCollectionTest.php line ", $message);
