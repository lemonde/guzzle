...
use Lmd\Guzzle\Http\QueryAggregator\CommaAggregator;

class QueryStringTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    /** @var \Lmd\Guzzle\Http\QueryString The query string object to test */
    protected $q;
