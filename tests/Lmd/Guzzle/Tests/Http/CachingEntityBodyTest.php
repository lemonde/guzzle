...
use Lmd\Guzzle\Http\CachingEntityBody;

/**
 * @covers \Lmd\Guzzle\Http\CachingEntityBody
 */
class CachingEntityBodyTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testRewindUsesSeek()
    {
        ...
        $d = $this->getMockBuilder('Lmd\Guzzle\Http\CachingEntityBody')
    ...
    {
        $a = $this->getMockBuilder('Lmd\Guzzle\Http\EntityBody')
