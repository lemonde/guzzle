...
/**
 * @covers \Lmd\Guzzle\Http\AbstractEntityBodyDecorator
 */
class AbstractEntityBodyDecoratorTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    public function testDecoratesEntityBody()
    {
        $e = EntityBody::factory();
        $mock = $this->getMockForAbstractClass('Lmd\Guzzle\Http\AbstractEntityBodyDecorator', array($e));
