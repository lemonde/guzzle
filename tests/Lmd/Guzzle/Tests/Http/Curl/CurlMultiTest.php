...
use Lmd\Guzzle\Http\Exception\MultiTransferException;
...
use Lmd\Guzzle\Tests\Mock\MockMulti;

/**
 * @group server
 * @covers \Lmd\Guzzle\Http\Curl\CurlMulti
 */
class CurlMultiTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    /** @var \Lmd\Guzzle\Http\Curl\CurlMulti */
    private $multi;
    ...
    public function testSendsRequestsThroughCurl()
    {
        ...
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Message\\Response', $response1);
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Message\\Response', $response2);
    ...
    public function testSendsThroughCurlAndAggregatesRequestExceptions()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Message\\Response', $response1);
            $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Message\\Response', $response2);
            $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Message\\Response', $response3);
    ...
    /**
     * @expectedException \Lmd\Guzzle\Common\Exception\ExceptionCollection
    ...
    {
        $client = new Client($this->getServer()->getUrl());
        $multi = $this->getMock('Lmd\\Guzzle\\Http\\Curl\\CurlMulti', array('perform'));
    ...
    public function testThrowsMeaningfulExceptionsForCurlMultiErrors()
    {
        ...
        $reflector = new \ReflectionMethod('Lmd\Guzzle\Http\Curl\CurlMulti', 'checkCurlResult');
