...
/**
 * @group server
 * @covers \Lmd\Guzzle\Http\Curl\CurlHandle
 */
class CurlHandleTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testConstructorInitializesObject()
    {
        ...
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Url', $h->getUrl());
    ...
    public function testFactoryCreatesCurlBasedOnRequest($method, $url, $headers, $body, $options, $expectedHeaders = null)
    {
        ...
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Curl\\CurlHandle', $handle);
