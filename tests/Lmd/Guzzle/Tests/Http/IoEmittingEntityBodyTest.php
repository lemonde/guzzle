...
use Lmd\Guzzle\Http\IoEmittingEntityBody;

/**
 * @covers \Lmd\Guzzle\Http\IoEmittingEntityBody
 */
class IoEmittingEntityBodyTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    protected $body;
    protected $decorated;
