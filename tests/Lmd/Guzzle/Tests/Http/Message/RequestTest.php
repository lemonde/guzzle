...
use Lmd\Guzzle\Plugin\Async\AsyncPlugin;
...
use Lmd\Guzzle\Http\RedirectPlugin;
use Lmd\Guzzle\Http\Exception\BadResponseException;

/**
 * @group server
 * @covers \Lmd\Guzzle\Http\Message\Request
 * @covers \Lmd\Guzzle\Http\Message\AbstractMessage
 */
class RequestTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    /** @var Request */
    protected $request;
    ...
    public function testSend()
    {
        ...
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Message\\Response', $this->request->getResponse());
    ...
    public function testGetResponse()
    {
        ...
        $requestResponse = $request->getResponse();
        $this->assertSame($response, $requestResponse);
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\EntityBody', $response->getBody());
    }
    ...
    public function testRequestThrowsExceptionOnBadResponse()
    {
        try {
            ...
            $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Message\\RequestInterface', $e->getRequest());
            $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Message\\Response', $e->getResponse());
    ...
    {
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\QueryString', $this->request->getQuery());
    ...
    /**
     * @expectedException \Lmd\Guzzle\Http\Exception\RequestException
    ...
    public function testCanRetrieveUrlObject()
    {
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Http\Url', $request->getUrl(true));
