...
namespace Lmd\Guzzle\Tests\Http\Message;

use Lmd\Guzzle\Common\Collection;
use Lmd\Guzzle\Http\Client;
use Lmd\Guzzle\Http\Message\Response;
use Lmd\Guzzle\Http\Url;
...
use Lmd\Guzzle\Parser\Message\MessageParser;
use Lmd\Guzzle\Plugin\Log\LogPlugin;
use Lmd\Guzzle\Plugin\Mock\MockPlugin;

/**
 * @group server
 * @covers \Lmd\Guzzle\Http\Message\RequestFactory
 */
class HttpRequestFactoryTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testCreatesNewGetRequests()
    {
        ...
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Message\\MessageInterface', $request);
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Message\\RequestInterface', $request);
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Message\\Request', $request);
    ...
    public function testCreatesPutRequests()
    {
        ...
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Message\\EntityEnclosingRequest', $request);
        ...
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\EntityBody', $request->getBody());
    ...
    public function testCreatesNewPostRequestWithFields()
    {
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Http\Message\PostFile', $files['file'][0]);
    }
    ...
    public function testCreatesNewTraceRequest()
    {
        ...
        $this->assertFalse($request instanceof \Lmd\Guzzle\Http\Message\EntityEnclosingRequest);
