...
use Lmd\Guzzle\Http\Message\PostFile;
use Lmd\Guzzle\Http\QueryString;

/**
 * @group server
 * @covers \Lmd\Guzzle\Http\Message\EntityEnclosingRequest
 */
class EntityEnclosingRequestTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    protected $client;
    ...
    public function testRequestHasMutableBody()
    {
        ...
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\EntityBody', $body);
    ...
    public function testSetPostFields()
    {
        ...
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\QueryString', $request->getPostFields());
