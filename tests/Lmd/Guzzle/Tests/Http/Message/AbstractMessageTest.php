...
use Lmd\Guzzle\Http\Message\Header;
 ...
 */
class AbstractMessageTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    {
        parent::setUp();
        $this->mock = $this->getMockForAbstractClass('Lmd\Guzzle\Http\Message\AbstractMessage');
    }
    ...
    public function testGetParams()
    {
        ...
        $this->assertInstanceOf('Lmd\\Guzzle\\Common\\Collection', $request->getParams());
    }
    ...
    public function testGetHeaders()
    {
        ...
        $this->assertInstanceOf('Lmd\Guzzle\Http\Message\Header\HeaderInterface', $h->get('a'));
        $this->assertInstanceOf('Lmd\Guzzle\Http\Message\Header\HeaderInterface', $h->get('c'));
    }
