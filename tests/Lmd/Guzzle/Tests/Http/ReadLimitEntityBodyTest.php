...
use Lmd\Guzzle\Http\ReadLimitEntityBody;

/**
 * @covers \Lmd\Guzzle\Http\ReadLimitEntityBody
 */
class ReadLimitEntityBodyTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
