...
use Lmd\Guzzle\Http\Exception\TooManyRedirectsException;
use Lmd\Guzzle\Plugin\History\HistoryPlugin;

/**
 * @covers \Lmd\Guzzle\Http\RedirectPlugin
 */
class RedirectPluginTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    /**
     * @expectedException \Lmd\Guzzle\Http\Exception\CouldNotRewindStreamException
     */
