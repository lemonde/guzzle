...
use Lmd\Guzzle\Inflection\MemoizingInflector;
use Lmd\Guzzle\Inflection\Inflector;

/**
 * @covers \Lmd\Guzzle\Inflection\MemoizingInflector
 */
class MemoizingInflectorTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
