...
namespace Lmd\Guzzle\Tests\Inflection;

use Lmd\Guzzle\Inflection\PreComputedInflector;

/**
 * @covers \Lmd\Guzzle\Inflection\PreComputedInflector
 */
class PreComputedInflectorTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    public function testUsesPreComputedHash()
    {
        $mock = $this->getMock('Lmd\Guzzle\Inflection\Inflector', array('snake', 'camel'));
