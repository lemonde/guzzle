...
use Lmd\Guzzle\Log\MessageFormatter;
use Lmd\Guzzle\Plugin\Log\LogPlugin;
use Lmd\Guzzle\Log\ClosureLogAdapter;

/**
 * @covers \Lmd\Guzzle\Log\MessageFormatter
 */
class MessageFormatterTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    protected $request;
    protected $response;
    protected $handle;
    ...
    public function setUp()
    {
        ...
        $this->handle = $this->getMockBuilder('Lmd\Guzzle\Http\Curl\CurlHandle')
