...
/**
 * @covers \Lmd\Guzzle\Cache\DoctrineCacheAdapter
 * @covers \Lmd\Guzzle\Cache\AbstractCacheAdapter
 */
class CacheAdapterTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    /** @var ArrayCache */
    private $cache;
