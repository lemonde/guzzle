...
/**
 * @covers \Lmd\Guzzle\Plugin\Cache\CallbackCanCacheStrategy
 */
class CallbackCanCacheStrategyTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    /**
    ...
    public function testIntegrationWithCachePlugin()
    {
        ...
        $s = $this->getMockBuilder('Lmd\Guzzle\Plugin\Cache\DefaultCacheStorage')
