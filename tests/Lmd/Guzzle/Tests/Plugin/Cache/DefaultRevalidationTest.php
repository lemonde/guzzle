...
use Lmd\Guzzle\Tests\Http\Server;

/**
 * @covers \Lmd\Guzzle\Plugin\Cache\DefaultRevalidation
 * @group server
 */
class DefaultRevalidationTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testHandles404RevalidationResponses()
    {
        ...
        $rev = $this->getMockBuilder('Lmd\Guzzle\Plugin\Cache\DefaultRevalidation')
