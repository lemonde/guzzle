...
use Lmd\Guzzle\Plugin\Cache\CachePlugin;
use Lmd\Guzzle\Plugin\Cache\DefaultCacheStorage;
use Lmd\Guzzle\Plugin\Cache\CallbackCanCacheStrategy;
use Doctrine\Common\Cache\ArrayCache;

/**
 * @group server
 * @covers \Lmd\Guzzle\Plugin\Cache\CachePlugin
 * @covers \Lmd\Guzzle\Plugin\Cache\DefaultRevalidation
 */
class CachePluginTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    public function testAddsDefaultStorage()
    {
        $plugin = new CachePlugin();
        $this->assertInstanceOf('Lmd\Guzzle\Plugin\Cache\CacheStorageInterface', $this->readAttribute($plugin, 'storage'));
    }
    ...
    public function testAddsDefaultCollaborators()
    {
        ...
        $plugin = new CachePlugin(array(
            'storage' => $this->getMockBuilder('Lmd\Guzzle\Plugin\Cache\CacheStorageInterface')->getMockForAbstractClass()
        ));
        $this->assertInstanceOf('Lmd\Guzzle\Plugin\Cache\CacheStorageInterface', $this->readAttribute($plugin, 'storage'));
        $this->assertInstanceOf(
            'Lmd\Guzzle\Plugin\Cache\CanCacheStrategyInterface',
            $this->readAttribute($plugin, 'canCache')
        );
        $this->assertInstanceOf(
            'Lmd\Guzzle\Plugin\Cache\RevalidationInterface',
    ...
    public function testAddsCallbackCollaborators()
    {
        ...
        $this->assertInstanceOf(
            'Lmd\Guzzle\Plugin\Cache\CallbackCanCacheStrategy',
            $this->readAttribute($plugin, 'canCache')
        );
    }
    ...
    {
        $plugin = new CachePlugin(array(
            'adapter' => $this->getMockBuilder('Lmd\Guzzle\Cache\CacheAdapterInterface')->getMockForAbstractClass()
        ));
        $this->assertInstanceOf('Lmd\Guzzle\Plugin\Cache\CacheStorageInterface', $this->readAttribute($plugin, 'storage'));
    }
    ...
    {
        $can = $this->getMockBuilder('Lmd\Guzzle\Plugin\Cache\CanCacheStrategyInterface')->getMockForAbstractClass();
        $revalidate = $this->getMockBuilder('Lmd\Guzzle\Plugin\Cache\RevalidationInterface')->getMockForAbstractClass();
        $plugin = new CachePlugin(array(
            'storage' => $this->getMockBuilder('Lmd\Guzzle\Plugin\Cache\CacheStorageInterface')->getMockForAbstractClass(),
            'can_cache' => $can,
    ...
    public function testChecksIfResponseCanSatisfyRequest($request, $response, $can, $revalidates)
    {
        $didRevalidate = false;
        $storage = $this->getMockBuilder('Lmd\Guzzle\Plugin\Cache\CacheStorageInterface')->getMockForAbstractClass();
        $revalidate = $this->getMockBuilder('Lmd\Guzzle\Plugin\Cache\DefaultRevalidation')
    ...
    {
        $storage = $this->getMockBuilder('Lmd\Guzzle\Plugin\Cache\CacheStorageInterface')
    ...
    public function testInjectsSatisfiableResponsesOnException($cacheResponse)
    {
        ...
        $plugin->onRequestException(
            new Event(array(
                'request' => $request,
                'response' => $request->getResponse(),
                'exception' => $this->getMock('Lmd\Guzzle\Http\Exception\CurlException'),
            ))
        );
