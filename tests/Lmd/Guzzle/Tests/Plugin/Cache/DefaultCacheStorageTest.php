...
/**
 * @covers \Lmd\Guzzle\Plugin\Cache\DefaultCacheStorage
 */
class DefaultCacheStorageTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    {
        $cache = $this->getCache();
        $this->assertInstanceOf('Lmd\Guzzle\Http\Message\Response', $cache['storage']->fetch($cache['request']));
