...
namespace Lmd\Guzzle\Tests\Plugin\CurlAuth;

use Lmd\Guzzle\Common\Version;
use Lmd\Guzzle\Plugin\CurlAuth\CurlAuthPlugin;
use Lmd\Guzzle\Http\Client;

/**
 * @covers \Lmd\Guzzle\Plugin\CurlAuth\CurlAuthPlugin
 */
class CurlAuthPluginTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
