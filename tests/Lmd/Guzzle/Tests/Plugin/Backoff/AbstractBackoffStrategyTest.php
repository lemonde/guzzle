...
/**
 * @covers \Lmd\Guzzle\Plugin\Backoff\AbstractBackoffStrategy
 */
class AbstractBackoffStrategyTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    protected function getMockStrategy()
    {
        return $this->getMockBuilder('Lmd\Guzzle\Plugin\Backoff\AbstractBackoffStrategy')
