...
use Lmd\Guzzle\Plugin\Cookie\CookieJar\FileCookieJar;

/**
 * @covers \Lmd\Guzzle\Plugin\Cookie\CookieJar\FileCookieJar
 */
class FileCookieJarTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    private $file;
