...
/**
 * @covers \Lmd\Guzzle\Plugin\Cookie\Cookie
 */
class CookieTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    {
        $m = new \ReflectionMethod('Lmd\Guzzle\Plugin\Cookie\Cookie', 'getInvalidCharacters');
        $m->setAccessible(true);
        $p = new \ReflectionProperty('Lmd\Guzzle\Plugin\Cookie\Cookie', 'invalidCharString');
