...
namespace Lmd\Guzzle\Tests\Plugin\Mock;
...
/**
 * @covers \Lmd\Guzzle\Plugin\Mock\MockPlugin
 */
class MockPluginTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testRetrievesResponsesFromFiles()
    {
        ...
        $this->assertInstanceOf('Lmd\\Guzzle\\Http\\Message\\Response', $response);
