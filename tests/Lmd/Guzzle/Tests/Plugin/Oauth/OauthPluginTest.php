...
namespace Lmd\Guzzle\Tests\Plugin\Oauth;

use Lmd\Guzzle\Http\Message\RequestFactory;
use Lmd\Guzzle\Plugin\Oauth\OauthPlugin;
use Lmd\Guzzle\Common\Event;

/**
 * @covers \Lmd\Guzzle\Plugin\Oauth\OauthPlugin
 */
class OauthPluginTest extends \Lmd\Guzzle\Tests\GuzzleTestCase
{
