...
class ParserRegistry
{
    ...
    protected $mapping = array(
        'message'      => 'Lmd\\Guzzle\\Parser\\Message\\MessageParser',
        'cookie'       => 'Lmd\\Guzzle\\Parser\\Cookie\\CookieParser',
        'url'          => 'Lmd\\Guzzle\\Parser\\Url\\UrlParser',
        'uri_template' => 'Lmd\\Guzzle\\Parser\\UriTemplate\\UriTemplate',
    );
    ...
    public function __construct()
    {
        ...
        if (extension_loaded('uri_template')) {
            $this->mapping['uri_template'] = 'Lmd\\Guzzle\\Parser\\UriTemplate\\PeclUriTemplate';
        }
    }
