...
namespace Lmd\Guzzle\Batch\Exception;

use Lmd\Guzzle\Common\Exception\GuzzleException;
use Lmd\Guzzle\Batch\BatchTransferInterface as TransferStrategy;
use Lmd\Guzzle\Batch\BatchDivisorInterface as DivisorStrategy;
