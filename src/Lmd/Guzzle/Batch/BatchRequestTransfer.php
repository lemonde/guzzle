...
use Lmd\Guzzle\Batch\BatchTransferInterface;
use Lmd\Guzzle\Batch\BatchDivisorInterface;
 ...
 * This class is to be used with {@see Lmd\Guzzle\Batch\BatchInterface}
 */
    ...
    public function createBatches(\SplQueue $queue)
    {
        ...
        foreach ($queue as $item) {
            if (!$item instanceof RequestInterface) {
                throw new InvalidArgumentException('All items must implement Lmd\Guzzle\Http\Message\RequestInterface');
            }
