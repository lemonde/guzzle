...
class BatchBuilder
{
    ...
    protected static $mapping = array(
        'request' => 'Lmd\Guzzle\Batch\BatchRequestTransfer',
        'command' => 'Lmd\Guzzle\Batch\BatchCommandTransfer'
    );
    ...
    /**
     * Configures the batch to transfer batches of requests. Associates a {@see \Lmd\Guzzle\Http\BatchRequestTransfer}
     ...
     * {@see \Lmd\Guzzle\Service\Command\BatchCommandTransfer} as both the transfer and divisor strategy.
     *
