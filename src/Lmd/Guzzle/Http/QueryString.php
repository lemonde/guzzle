...
use Lmd\Guzzle\Http\QueryAggregator\DuplicateAggregator;
use Lmd\Guzzle\Http\QueryAggregator\QueryAggregatorInterface;
use Lmd\Guzzle\Http\QueryAggregator\PhpAggregator;
...
class QueryString extends Collection
{
     ...
     * @return self
     * @see \Lmd\Guzzle\Http\QueryString::aggregateUsingComma()
     */
