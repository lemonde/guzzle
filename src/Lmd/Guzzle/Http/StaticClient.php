...
namespace Lmd\Guzzle\Http;

use Lmd\Guzzle\Http\Client;
use Lmd\Guzzle\Http\ClientInterface;
use Lmd\Guzzle\Stream\StreamRequestFactoryInterface;
...
final class StaticClient
{
     ...
     */
    public static function mount($className = 'Lmd\Guzzle', ClientInterface $client = null)
    {
     ...
     * @param  array  $options Options to use with the request. See: Lmd\Guzzle\Http\Message\RequestFactory::applyOptions()
     * @return \Lmd\Guzzle\Http\Message\Response|\Lmd\Guzzle\Stream\Stream
     */
     ...
     *
     * @return \Lmd\Guzzle\Http\Message\Response
