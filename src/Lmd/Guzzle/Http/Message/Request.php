...
namespace Lmd\Guzzle\Http\Message;
...
use Lmd\Guzzle\Http\ClientInterface;
use Lmd\Guzzle\Http\EntityBody;
use Lmd\Guzzle\Http\EntityBodyInterface;
use Lmd\Guzzle\Http\Message\Header\HeaderInterface;
...
class Request extends AbstractMessage implements RequestInterface
{
    ...
    /**
     * @deprecated Use Lmd\Guzzle\Plugin\Cache\DefaultCanCacheStrategy
     * @codeCoverageIgnore
     */
    public function canCache()
    {
        Version::warn(__METHOD__ . ' is deprecated. Use Lmd\Guzzle\Plugin\Cache\DefaultCanCacheStrategy.');
        if (class_exists('Lmd\Guzzle\Plugin\Cache\DefaultCanCacheStrategy')) {
            $canCache = new \Lmd\Guzzle\Plugin\Cache\DefaultCanCacheStrategy();
