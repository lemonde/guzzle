...
use Lmd\Guzzle\Common\HasDispatcherInterface;
use Lmd\Guzzle\Common\Collection;
use Lmd\Guzzle\Common\Exception\InvalidArgumentException;
use Lmd\Guzzle\Http\Message\EntityEnclosingRequestInterface;
...
interface ClientInterface extends HasDispatcherInterface
{
     ...
     * @see \Lmd\Guzzle\Http\Message\RequestFactoryInterface::applyOptions for a full list of request.options options
     */
     ...
     * @return RequestInterface
     * @see    \Lmd\Guzzle\Http\ClientInterface::createRequest()
     */
     ...
     *
     * @return \Lmd\Guzzle\Http\Message\Response|array Returns a single Response or an array of Response objects
     */
