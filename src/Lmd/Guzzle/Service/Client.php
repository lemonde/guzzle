...
namespace Lmd\Guzzle\Service;

use Lmd\Guzzle\Common\Collection;
use Lmd\Guzzle\Common\Exception\InvalidArgumentException;
use Lmd\Guzzle\Common\Exception\BadMethodCallException;
use Lmd\Guzzle\Common\Version;
use Lmd\Guzzle\Inflection\InflectorInterface;
use Lmd\Guzzle\Inflection\Inflector;
use Lmd\Guzzle\Http\Client as HttpClient;
...
use Lmd\Guzzle\Service\Command\Factory\FactoryInterface as CommandFactoryInterface;
use Lmd\Guzzle\Service\Resource\ResourceIteratorClassFactory;
use Lmd\Guzzle\Service\Resource\ResourceIteratorFactoryInterface;
use Lmd\Guzzle\Service\Description\ServiceDescriptionInterface;
