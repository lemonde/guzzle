...
namespace Lmd\Guzzle\Service\Description;
...
class Operation implements OperationInterface
{
    ...
    const DEFAULT_COMMAND_CLASS = 'Lmd\\Guzzle\\Service\\Command\\OperationCommand';
     ...
     * 'Lmd\\Guzzle\\Foo\\Baz', or 'MyModelName' (to reference a model by ID).
     *
